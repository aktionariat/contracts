...
module.exports = async function ({ ethers, deployments, getNamedAccounts }) {
  ...
  const shares = await deployments.get('SharesEX');
  ...
  if (network.name != "hardhat") {
    console.log("-----------------------");
    console.log("Deploy EX DraggableShares");
    console.log("-----------------------");
  ...
  const { address } = await deploy("DraggableSharesEX", {
...
module.exports.tags = ["DraggableSharesEX"];
module.exports.dependencies = ["SharesEX", "RecoveryHub", "OfferFactory"];