...
const AFSSecondaryMarket260116Module = buildModule("AFSSecondaryMarket260116Module", (m) => {
  ...
  m.call(secondaryMarketFactory, "deploy", [backendOwner, config.zchfAddress, config.afsAddress, config.tradeReactorAddress, config.backendRouterAddress], { from: backendOwner });
  return { 
    secondaryMarketFactory
   };
});

export default AFSSecondaryMarket260116Module;