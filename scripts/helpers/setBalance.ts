...
export async function getStorageAt(address: string, position: bigint) {
    return await provider.request({method: "eth_getStorageAt", params: [address, "0x" + position.toString(16), "latest"]});
};
